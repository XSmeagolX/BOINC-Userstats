				...
				<?php if (!$didVersionEdit): ?>
					<?php if ($setUpdatecheck): ?>
						<?php if ( $update_available ): ?>
							<li class = 'nav-item'>
							<a class = 'nav-link' href = 'check_update.php' class = 'btn btn-neutral btn-simple textgelb'><i class="textgelb fas fa-exclamation-circle"></i><font class = 'textgelb'> <?=$linkNameUpdate ?></font></a>
							</li>
						<?php endif; ?>
					<?php endif; ?>
				<?php endif; ?>
